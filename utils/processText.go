...
func ProcessText(text string, newline bool) string {
	...
	text = strings.ReplaceAll(text, "https://www.twitter.com", viper.GetString("DOMAIN_TWITTER"))
	text = strings.ReplaceAll(text, "https://twitter.com", viper.GetString("DOMAIN_TWITTER"))
	text = strings.ReplaceAll(text, "https://www.youtube.com", viper.GetString("DOMAIN_YOUTUBE"))
	text = strings.ReplaceAll(text, "https://youtube.com", viper.GetString("DOMAIN_YOUTUBE"))
	text = strings.ReplaceAll(text, "https://www.instagram.com", viper.GetString("DOMAIN_INSTAGRAM"))
	text = strings.ReplaceAll(text, "https://instagram.com", viper.GetString("DOMAIN_INSTAGRAM"))
	text = strings.ReplaceAll(text, "https://www.reddit.com", viper.GetString("DOMAIN_REDDIT"))
	text = strings.ReplaceAll(text, "https://reddit.com", viper.GetString("DOMAIN_REDDIT"))
